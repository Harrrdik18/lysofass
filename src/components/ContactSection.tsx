...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-supreme-blue py-20">
          ...
          <div className="animate-slide-in-right">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="bg-supreme-light-blue text-white px-8 py-3 rounded-lg hover:bg-white hover:text-supreme-blue transition-colors font-medium"
                >
                  Send
                </button>
              </div>
