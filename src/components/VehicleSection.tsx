    ...
    <div className="blade-top-padding blade-bottom-padding bg-black manrope-600">
      ...
      >
        <div className="w-container max-w-none flex flex-col h-full justify-between gap-4 2xl:gap-10 w-full">
          ...
          {/* Controls */}
          <div className="hidden lg:flex justify-end items-center relative w-container my-auto">
            <div className="flex justify-center w-[640px] xl:w-[720px] 2xl:w-[900px] relative right-12">
              ...
              <div className="video-control-1 absolute right-8 top-0 bottom-0 my-auto z-50 flex items-center">
